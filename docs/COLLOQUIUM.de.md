...
Eine detaillierte Übersicht mit Bildern finden Sie auf der Seite [Beispiele](EXAMPLES.de.md#thesis-kolloquium).

### 1. [LaTeX-Protokollbrief](EXAMPLES.de.md#latex-protokollbrief)
**Dateiname:** `bewertung_brief_<matrikelnr>.tex`
Ein formeller `scrlttr2`-Brief mit dem Briefkopf und Fußzeile der TH Köln.

### 2. [Kompiliertes PDF](EXAMPLES.de.md#kompiliertes-pdf)
**Dateiname:** `bewertung_brief_<matrikelnr>.pdf`
Das druckfertige PDF des Protokollbriefs (erfordert LuaLaTeX).

### 3. [Vorausgefülltes Bewertungsformular](EXAMPLES.de.md#vorausgefulltes-bewertungsformular)
...
### 4. [E-Mail- & Outlook-Entwurf](EXAMPLES.de.md#e-mail-outlook-entwurf)
...
Sie können das Tool auch über die `main.py` ausführen, indem Sie dort den Pfad zum Thesis-Ordner angeben. Details dazu finden Sie im [Konfigurations-Handbuch](configuration.de.md#3-tool-ausfuhren).
