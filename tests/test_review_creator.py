"""
Unit tests for the review_creator package.
"""
...
class TestMdGenerator:
    ...
    def test_find_line_number_from_text_found(self):
        ...
        annot_bbox = (45, 95, 115, 115)  # Overlaps with "Some text"
...
class TestReviewIntegration:
    ...
    def test_full_review_flow(self):
        ...
        pages_words = {
            0: [
                {"text": "15", "bbox": (10, 500, 20, 510)},
                {"text": "This", "bbox": (50, 500, 80, 510)},
                {"text": "needs", "bbox": (85, 500, 120, 510)},
                {"text": "review", "bbox": (125, 500, 170, 510)},
            ]
        }
